...
export type EnqueueBulkJobInputType = {
  /** The job to enqueue. @see EnqueueJobInputType */
  job: EnqueueJobInputType;
  /** A name for this Job, unique to the Queue */
  name: Scalars['String'];
};
...
export type Mutation = {
  ...
  cancelJob?: Maybe<Job>;
  /**
   * Cancels upcoming jobs in bulk. This is the bulk operation for cancelJob.
   * Jobs that no longer exist in Taskless will be omitted from the returned
   * Job set The maximum number of jobs you can cancel in a single bulk
   * operation is 100. Jobs beyond the first 100 will be ignored.
   */
  cancelJobs?: Maybe<Array<Maybe<Job>>>;
  /**
  ...
  enqueueJob: Job;
  /**
   * Create new jobs in bulk, or replace existing jobs. This is the bulk operation
   * for enqueueJob. The maximum number of jobs you can queue in a single bulk
   * operation is 100. Jobs beyond the first 100 will be ignored.
   */
  enqueueJobs?: Maybe<Array<Job>>;
};
...
export type MutationEnqueueJobsArgs = {
  jobs: Array<EnqueueBulkJobInputType>;
};
...
export type EnqueueJobsMutationVariables = Exact<{
  jobs: Array<EnqueueBulkJobInputType> | EnqueueBulkJobInputType;
}>;


export type EnqueueJobsMutation = { __typename?: 'Mutation', enqueueJobs?: Array<{ __typename?: 'Job', id: string, name: string, enabled: boolean, endpoint: string, headers?: any | null, body?: string | null, retries: number, runAt: any, runEvery?: any | null, timezone?: any | null }> | null };
...
export type CancelJobsMutationVariables = Exact<{
  names: Array<Scalars['String']> | Scalars['String'];
}>;


export type CancelJobsMutation = { __typename?: 'Mutation', cancelJobs?: Array<{ __typename?: 'Job', id: string, name: string, enabled: boolean, endpoint: string, headers?: any | null, body?: string | null, retries: number, runAt: any, runEvery?: any | null, timezone?: any | null } | null> | null };
